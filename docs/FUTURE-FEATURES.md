...
- [ ] Invitation via Whatsapp atau lainnya masih mengirim hanya https://app.digsan.id, harusnya ada /tree/nama-keluarga/nama-user, apa belum aktif/dibuild?;
- [ ] Sebenarnya sudahkah seseorang dan family memiliki link publik? bisakah non-user mengakses profil publik tree user/family aktif atau user/family non-aktif yang memang perlu diaktifkan oleh orang yang diberikan undangan tersebut? Misalnya adanya fitur siapapun yang punya link bisa mengakses halaman tersebut.
