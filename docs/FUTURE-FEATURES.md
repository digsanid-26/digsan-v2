...
- [ ] Kemudian masalah fitur Family Node milik keluarga utama yang perlu diperbarui/diubah dan dibatasi akses pengaturannya hanya dimiliki oleh kepala keluarga atau single parent (bisa wanita) yang memiliki role super_user. Family Node berfungsi sebagai wadah untuk keluarga terkecil yaitu suami, istri dan anak-anak yang sebelumnya sudah diset otomatis tergabung ke dalamnya. Jadi, dengan konsep ini, anggota keluarga akan memiliki halaman public family yang sama, bisa mengaksesnya, serta terdata/tersimpan di masing-masing profil dan detil anggota.
- [ ] Tree Family Node perlu dibuat sebagai alternatif dari tree yang sekarang yang terdiri atas node/lingkaran familymember. Node/lingkaran dari Tree Family Node diambil dari image cover family node. Susunannya hampir sama dengan tree Familymember; ke atas menuju 2 family node orang tua dari kedua belah pihak, ke samping kiri mengarah ke family node saudara-saudara suami, ke kanan mengarah ke family node saudara-saudara istri. Tidak ada family node anak kecuali anak juga telah berkeluarga. 
