...
- [ ] Bisa login familymember yang telah dibuatkan earlyaccess melalui halaman family/nama-keluarga yang dikelolanya. Pada modal yang muncul ketika node diklik terdapat tombol login early access.
...
- [x] Fitur super_user /app.digsan.id/super-user/nodes sebenarnya yang dimaksud adalah untuk lingkaran (familymember) yang dibuat oleh super_user, namun kemarin menggunakan istilah node yang ternyata .
