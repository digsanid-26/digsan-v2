...
- [ ] Tree Family Node perlu dibuat sebagai alternatif dari tree yang sekarang yang terdiri atas node/lingkaran familymember. Node/lingkaran dari Tree Family Node diambil dari image cover family node. Susunannya family node sendiri menonjol di tengah, garis dibuat dua ke atas menuju 2 family node orang tua dari kedua belah pihak, ke samping kiri mengarah ke family node saudara-saudara suami, ke kanan mengarah ke family node saudara-saudara istri. Ke bawah ke family node anak-anak yang sudah berkeluarga. 
