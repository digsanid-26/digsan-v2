...
export default function HeaderNav() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-2.5 pl-1 pr-3 py-1 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all"
      >
        {/* Avatar */}
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute right-0 mt-2 w-52 rounded-2xl overflow-hidden border border-white/10 shadow-2xl z-50"
